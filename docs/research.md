...
## Multi-Currency Review UX

Researched on 2026-07-12.

- Spendee keeps overview and timeline totals in the account currency, while a foreign transaction is displayed in both its original currency and the account currency. This preserves what the user paid without making mixed-currency totals mathematically ambiguous: https://help.spendee.com/article/231-how-to-setchange-the-currency-and-exchange-rate
- PocketSmith supports either base-currency reporting or native-currency views, shows separate totals per native currency, stores daily conversion rates, and offers currency filtering for retrieval: https://learn.pocketsmith.com/article/122-multi-currency-beta-features-in-pocketsmith and https://learn.pocketsmith.com/article/157-using-the-transactions-page
- BudgetBakers Wallet keeps a fixed default currency, supports additional tracked currencies, and updates their exchange rates automatically. A stable reporting currency is therefore an established pattern rather than a LocalSpend-specific restriction: https://support.budgetbakers.com/hc/en-us/articles/7149418777746-Multiple-Currencies-Exchange-Rates and https://support.budgetbakers.com/hc/en-us/articles/7151352625938-Getting-Started-with-Wallet
- LocalSpend uses the least ambiguous hybrid for occasional travel spending: budgets, comparisons, calendar totals, and category totals remain in the main currency; foreign periods gain a compact breakdown of original amounts; individual entries show original amount first and the saved main-currency equivalent second; Summary currency chips open the matching monthly entries.
